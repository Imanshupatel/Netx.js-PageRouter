      ...
      <div className="max-w-2xl mx-auto mt-20 text-center">
        <div className="bg-gradient-to-r from-blue-400 via-pink-400 to-yellow-400 rounded-2xl p-1 shadow-xl">
          <div className="bg-white rounded-2xl py-8 px-6">
            ...
            <a href="/register" className="inline-block bg-blue-600 hover:bg-pink-500 text-white font-semibold px-8 py-3 rounded-full shadow transition-all duration-200">Get Started</a>
          </div>
        </div>
      </div>
    </section>
