...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-black via-pink-100 to-yellow-100 p-4">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-2xl w-full mt-8">
                ...
                <p className="text-gray-400 text-xs text-center mt-8">&copy; {new Date().getFullYear()} BattleGround Mobile. All rights reserved.</p>
            </div>
        </div>
    );
};
